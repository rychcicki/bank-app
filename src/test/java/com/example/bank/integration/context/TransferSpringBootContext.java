...
import com.example.bank.bank.transfer.transfer.TransferController;
...
public class TransferSpringBootContext {
    ...
    @Bean
    public TransferController transferController(TransferService transferService,
                                                 XlsxTransferHistoryGenerator xlsxTransferHistoryGenerator) {
        return new TransferController(transferService, xlsxTransferHistoryGenerator);
    }
